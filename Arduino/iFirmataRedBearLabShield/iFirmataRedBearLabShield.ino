...
void readAndReportData(byte address, int theRegister, byte numBytes) {
  ...
  if(numBytes == Wire.available()) {
    ...
    /*
      ...
      Serial.print(i2cRxData[2]);
      Serial.print(" ");
      Serial.println(i2cRxData[3]);
      
        int x = ((int16_t)(i2cRxData[3] << 8 | i2cRxData[2])) >> 4;
        Serial.print("x is:");
        Serial.println(x);*/
