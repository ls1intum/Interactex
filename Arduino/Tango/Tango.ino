/*
Interactex is a configuration tool to easily connect e-Textile hardware with iOS device functionality.
Copyright (C) 2013 TU Munich, Munich, Germany; DRLab, Berlin, Germany; Telekom Innovation Laboratories, Berlin, Germany
  

This program was designed and implemented as part of "Wearable M2M", a joint project of UdK Berlin and TU Munich, which was founded by Telekom Innovation Laboratories Berlin.

	

For contacting us, please use
