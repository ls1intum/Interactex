...
iFirmataClass::iFirmataClass(SoftwareSerial &s) : FirmataSerial(s)
{
...
void iFirmataClass::begin(SoftwareSerial &s)
{
  FirmataSerial = s;
  systemReset();
  printVersion();
...
void iFirmataClass::blePrintSendBufferBetweenStartAndEnd(){
...
iFirmataClass iFirmata(softwareSerial);
