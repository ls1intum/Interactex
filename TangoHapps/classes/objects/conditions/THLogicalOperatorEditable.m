...
#import "THLogicalOperatorEditable.h"
#import "THLogicalOperator.h"

@implementation THLogicalOperatorEditable

-(float) result{
    THLogicalOperator * operator = (THLogicalOperator*) self.simulableObject;
