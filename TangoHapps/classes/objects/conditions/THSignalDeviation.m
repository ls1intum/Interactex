...
@implementation THSignalDeviation
...
-(id)copyWithZone:(NSZone *)zone {
    THSignalDeviation * copy = [super copyWithZone:zone];
...
-(void) computeDeviation{
    ...
    _deviation = sqrt(_deviation / (count-1));
}

-(void) addSample:(float)value{
    buffer[count] = value;
    count++;
    if(count >= kSignalDeviationMaxSamples){
