...
@implementation THLogicalOperator


-(id) init{
    self = [super init];
    if(self){
        [self loadLogicalOperator];
...
-(id)initWithCoder:(NSCoder *)decoder {
    ...
    if(self){
        _operand1 = [decoder decodeBoolForKey:@"operand1"];
        _operand2 = [decoder decodeBoolForKey:@"operand2"];
...
-(void)encodeWithCoder:(NSCoder *)coder {
    ...
    [coder encodeBool:_operand1 forKey:@"operand1"];
    [coder encodeBool:_operand2 forKey:@"operand2"];
...
-(id)copyWithZone:(NSZone *)zone {
    THLogicalOperator * copy = [super copyWithZone:zone];
