/*
 THActivityRecognitionEditable.m
 Interactex Designer
...
@implementation THActivityRecognitionEditable
...
-(id)copyWithZone:(NSZone *)zone {
    THActivityRecognitionEditable * copy = [super copyWithZone:zone];
    if(copy){
    }
    return copy;
}
...
-(void) addSample:(THAccelerometerData*)value{
    ...
    THActivityRecognition * activityRecognition = (THActivityRecognition*) self.simulableObject;
    [activityRecognition addSample:value];
}
