...
#import "THLowPassFilterEditable.h"
#import "THLowPassFilter.h"

@implementation THLowPassFilterEditable
...
-(id) init{
    self = [super init];
    if(self){
        self.simulableObject = [[THLowPassFilter alloc] init];
...
-(void) loadLowPassFilter{
    ...
    self.programmingElementType = kProgrammingElementTypeLowPassFilter;
...
-(id)copyWithZone:(NSZone *)zone {
    THLowPassFilterEditable * copy = [super copyWithZone:zone];
    if(copy){
    }
    return copy;
}
