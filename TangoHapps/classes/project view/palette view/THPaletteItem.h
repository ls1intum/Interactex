...
-(void) didTapPaletteItem:(THPaletteItem*) item;
-(void) didRemovePaletteItem:(THPaletteItem*) item;
@end

@interface THPaletteItem : UIView <NSCoding, TFDroppable, UITextFieldDelegate, TFEditable> {
