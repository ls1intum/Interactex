...
-(void)reloadData {
    ...
    for(NSUInteger i = 0; i < count; i++){
        THGridItem *item = [_dataSource gridView:self viewAtIndex:i];
        item.delegate = self;
...
-(void)didRenameGridItem:(THGridItem*)item newName:(NSString*)newName
{
    NSUInteger index = [_items indexOfObject:item];
